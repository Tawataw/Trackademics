...
export function XerneasFAB({ onClick, isOpen, className = '' }: XerneasFABProps) {
  return (
    ...
    >
      ...
      {/* Icon pill */}
      <span className="relative flex items-center justify-center w-7 h-7 rounded-full bg-current/15 text-primary-foreground shadow-inner">
        <Sparkles className="w-4 h-4 animate-spin-slow" />
      </span>
      
      {/* Label */}
      <span className="relative font-semibold text-sm tracking-wide hidden xs:inline-block sm:inline-block text-primary-foreground">
        Xerneas AI
      </span>
